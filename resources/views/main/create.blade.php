...
@section('content')
    ...
    <div class="container-fluid"id="display" style="visibility: hidden;">
        {{ Form::open(array('url' => 'solutions', 'method' => 'POST', 'files' => true))}}
        <h1>
            <div class="row">
                <div class="col-md-5">
                    <i class="fas fa-plus"></i> @lang("Create New Solution")
                </div>
                <div class="col-md-2">
    ...
    <div class="row">
        ...
        <div class="col-md-3" >
            <div class="form-group">
                ...
                <label id="familyId" style="visibility: hidden;">@lang("Köpek Irkı: ")</label>
            ...
            <div class="modal-dialog  modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">@lang("Yiyecek Seç")</h5>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr class="table-active">
                                                    <th scope="col">@lang("Food Name")</th>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr class="table-active">
                                                    ...
                                                    <th scope="col">@lang("Megnazyum")</th>
                    ...
                    if(sonuc.state == true)
                    {
                        for (i = 0; i < sonuc.keys.length; i++) {
                            ...
                            while(row=table.rows[r++])
                            {
                                ...
                                {
                                    foods.push(sonuc.keys[i]);
                                    foodValue1.push(sonuc.values[i]);
                        ...
                        if(animalID){
                            ...
                            table.rows[1].cells[9].innerHTML = '';
                            table.rows[1].cells[10].innerHTML = '';

                            table.rows[2].cells[5].innerHTML = '';

                            table.rows[2].cells[6].innerHTML ='';
                            table.rows[2].cells[7].innerHTML = '';
                            table.rows[2].cells[8].innerHTML = '';
                            table.rows[2].cells[9].innerHTML = '';
                            table.rows[2].cells[10].innerHTML = '';

                            table.rows[3].cells[5].innerHTML = '';

                            table.rows[3].cells[6].innerHTML ='';
                            table.rows[3].cells[7].innerHTML ='';
                            table.rows[3].cells[8].innerHTML = '';
                            table.rows[3].cells[9].innerHTML ='';
                            table.rows[3].cells[10].innerHTML = '';


                            table.rows[4].cells[5].innerHTML = '';

                            table.rows[4].cells[6].innerHTML ='';
                            table.rows[4].cells[7].innerHTML = '';
                            table.rows[4].cells[8].innerHTML = '';
                            table.rows[4].cells[9].innerHTML = '';
                            table.rows[4].cells[10].innerHTML = '';

                            table.rows[5].cells[5].innerHTML = '';

                            table.rows[5].cells[6].innerHTML ='';
                            table.rows[5].cells[7].innerHTML = '';
                            table.rows[5].cells[8].innerHTML = '';
                            table.rows[5].cells[9].innerHTML = '';
                            table.rows[5].cells[10].innerHTML = '';

                            table.rows[6].cells[5].innerHTML = '';

                            table.rows[6].cells[6].innerHTML ='';
                            table.rows[6].cells[7].innerHTML ='';
                            table.rows[6].cells[8].innerHTML = '';
                            table.rows[6].cells[9].innerHTML = '';
                            table.rows[6].cells[10].innerHTML ='';

                            table.rows[7].cells[5].innerHTML = '';

                            table.rows[7].cells[6].innerHTML ='';
                            table.rows[7].cells[7].innerHTML ='';
                            table.rows[7].cells[8].innerHTML = '';
                            table.rows[7].cells[9].innerHTML = '';
                            table.rows[7].cells[10].innerHTML ='';

                            table.rows[8].cells[5].innerHTML = '';

                            table.rows[8].cells[6].innerHTML ='';
                            table.rows[8].cells[7].innerHTML = '';
                            table.rows[8].cells[8].innerHTML = '';
                            table.rows[8].cells[9].innerHTML = '';
                            table.rows[8].cells[10].innerHTML = '';

                            table.rows[9].cells[5].innerHTML = '';

                            table.rows[9].cells[6].innerHTML ='';
                            table.rows[9].cells[7].innerHTML = '';
                            table.rows[9].cells[8].innerHTML = '';
                            table.rows[9].cells[9].innerHTML = '';
                            table.rows[9].cells[10].innerHTML = '';

                            table.rows[10].cells[5].innerHTML = '';

                            table.rows[10].cells[6].innerHTML ='';
                            table.rows[10].cells[7].innerHTML = '';
                            table.rows[10].cells[8].innerHTML ='';
                            table.rows[10].cells[9].innerHTML = '';
                            table.rows[10].cells[10].innerHTML = '';

                            table.rows[11].cells[5].innerHTML = '';

                            table.rows[11].cells[6].innerHTML ='';
                            table.rows[11].cells[7].innerHTML = '';
                            table.rows[11].cells[8].innerHTML = '';
                            table.rows[11].cells[9].innerHTML = '';
                            table.rows[11].cells[10].innerHTML = '';

                            table.rows[12].cells[5].innerHTML = '';

                            table.rows[12].cells[6].innerHTML ='';
                            table.rows[12].cells[7].innerHTML = '';
                            table.rows[12].cells[8].innerHTML = '';
                            table.rows[12].cells[9].innerHTML = '';
                            table.rows[12].cells[10].innerHTML = '';

                            table.rows[13].cells[5].innerHTML = '';

                            table.rows[13].cells[6].innerHTML ='';
                            table.rows[13].cells[7].innerHTML ='';
                            table.rows[13].cells[8].innerHTML = '';
                            table.rows[13].cells[9].innerHTML = '';
                            table.rows[13].cells[10].innerHTML ='';

                            table.rows[14].cells[5].innerHTML = '';

                            table.rows[14].cells[6].innerHTML ='';
                            table.rows[14].cells[7].innerHTML ='';
                            table.rows[14].cells[8].innerHTML = '';
                            table.rows[14].cells[9].innerHTML = '';
                            table.rows[14].cells[10].innerHTML = '';
                            console.log(foodValue1);
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                /* send the csrf-token and the input to the controller */
                                data: {_token: CSRF_TOKEN, data:[foods,foodValue1,animalID] },
                                dataType: 'JSON',
                                /* remind that 'data' is the response of the AjaxController */
                                success: function (data) {
                                    // console.log(data);
